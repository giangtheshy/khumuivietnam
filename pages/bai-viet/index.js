    ...
    <div className={styles.posts}>
      ...
      <section className={styles.postsWrapper}>
        <div className={styles.postsCenter}>
          <div className={styles.header}><h1>Toàn bộ bài viết của khumuivietnam.com</h1></div>
          <div className={styles.postsContainer}>
            ...
            {posts.map((post) => {
              ...
              return (
                ...
                <article className={styles.postCenter} key={post._id} onClick={() => router.push(`/bai-viet/${convertLink(post.title)}`)}>
                  ...
                  <div className={styles.postCenter__detail}>
                    ...
                    <div className={styles.postCenter__detail_footer}>
                      ...
                      <p className={styles.timer}>{`Đăng vào lúc ${date.getDate()}-${date.getMonth() + 1
                        }-${date.getFullYear()}`}</p>
                    </div>
                  </div>
